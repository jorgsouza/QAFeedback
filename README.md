...
- **Jira:** você escolhe o **motivo da abertura** (Bug/Sub-Bug) na lista definida para o projeto.
...
- **Modo diagnóstico completo** (nas **opções**): ao enviar para o Jira, pode anexar um **arquivo `.har`** com o tráfego HTTP da aba (para o dev importar no DevTools), com cabeçalhos sensíveis redigidos.
...
1. **Configure** uma vez: tokens, domínios, repositórios GitHub e/ou quadro Jira — veja [extension/README.md](extension/README.md).
