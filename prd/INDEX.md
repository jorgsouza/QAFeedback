...
| **PRD-009** | UX da página de opções / configuração | [prd.md](PRD-009-options-config-ux/prd.md) | Em curso — branch `feature/options-config-ux-refactor`; Fases 1–3 (layout → conexão Jira → estados) |
